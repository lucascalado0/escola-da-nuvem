...
import math #biblioteca com métodos matemátios


raio = (float(input("Informe o valor do raio(ex: 1.00): ")))
areaCircunferencia = math.pi * math.pow(raio, 2)

print(f"Valor do raio: {raio}")
print(f"A = {areaCircunferencia:.4f}")